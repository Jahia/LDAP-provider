 ...
 * @author kevan
 */
public class LDAPCacheManagerImpl implements LDAPCacheManager {
    ...
    private static final Logger logger = LoggerFactory.getLogger(LDAPCacheManagerImpl.class);
    void start(){
        logger.info("Starting LDAPCache Manager");
        ...
        CacheConfiguration cacheConfiguration = userCache.getCacheConfiguration();
        cacheConfiguration.eternal(false);
        cacheConfiguration.setTimeToLiveSeconds(0);
        cacheConfiguration.setTimeToIdleSeconds(60*15);//15mn
        logger.info("Is userCache eternal? "+userCache.getCacheConfiguration().isEternal());
        ...
        cacheConfiguration = groupCache.getCacheConfiguration();
        cacheConfiguration.eternal(false);
        cacheConfiguration.setTimeToLiveSeconds(0);
        cacheConfiguration.setTimeToIdleSeconds(60*30);//30mn
    }
